class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        if (this.caller != 'LoadingScene') {
            this.btnReturn = this.add.sprite(getXY(0.04), getXY(0.04), 'btn_close').setOrigin(0, 0).setScale(0.4 * MIN_XY / 600).setInteractive().setDepth(100)
        ...
        this.btnSettings.on('pointerdown', () => scene.startScene('LevelEditScene'))
    }
