...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Next button
        var gameScene = this
        this.btnNext = this.add.sprite(900, 100, 'btn_next').setScale(0.25).setInteractive().setDepth(100);
        ...
        // Restart button
        this.btnRestart = this.add.sprite(900, 100, 'btn_restart').setScale(0.25).setInteractive().setDepth(100);
        ...
        // Sound change button
        this.btnVolume = this.add.sprite(VOL_POS_X, VOL_POS_Y, 'btn_volume').setScale(0.25).setInteractive().setDepth(100);
        ...
        // Level change button
        this.btnLevels = this.add.sprite(90, 90, 'btn_levels').setScale(0.25).setInteractive().setDepth(100);
